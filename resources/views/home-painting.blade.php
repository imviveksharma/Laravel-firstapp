  ...
  <div>
    ...
    <div>
        <div>
            ...
            <h1>Home Painting In Bangalore</h1>
    ...
    <div class="col-md-6 left-card">
      <div class="card">
        <div class="card-body">
          ...
          <h4 style="color:blue;text-align:center;">Interior & Exterior Painting</h4>
          <ul>
            <li>Tractor Emulsion</li>
            <li>Royale Luxury</li>
            <li>Premium Emulsion and More</li>
          </ul>
    ...
    <div class="col-md-6 right-card">
      <div class="card">
        <div class="card-body">
          ...
          <p class="card-text">Addon Services is only valid after booking of painting services.</p>
          <ul>
            <li>Gates Paint @Rs499</li>
            <li>Almirah Paint @ Rs499</li>
            <li>Window Paint @ Rs499</li>
            <li style="margin-bottom:27px;">Window Gril @ Rs499</li>
          </ul>
        </div>
      </div>
    </div>
