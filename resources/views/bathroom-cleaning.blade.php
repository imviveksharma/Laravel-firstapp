  ...
  <div>
    ...
    <div>
        <div>
            ...
            <h1>Bathroom Cleaning In Bangalore</h1>
    ...
    <div class="col-md-6 left-card">
      <div class="card">
        <div class="card-body">
          ...
          <h4 style="color:blue;text-align:center;">Bathroom Services</h4>
          <ul>
            <li>3 Service/Year @ 6 Bathrooms</li>
            <li>6 Service/Year @ 12 Bathrooms</li>
            <li>8 Service/Year @ 16 Bathrooms</li>
          </ul>
    ...
    <div class="col-md-6 right-card">
      <div class="card">
        <div class="card-body">
          ...
          <p class="card-text">Addon Services is only valid after booking of cleaning services.</p>
          <ul>
            <li>2 Bathrooms @Rs1999</li>
            <li>3 Bathrooms @Rs2499</li>
