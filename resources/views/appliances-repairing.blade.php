  ...
  <div>
    ...
    <div>
        <div>
            ...
            <h1>Appliances Repairing In Bangalore</h1>
    ...
    <div class="col-md-6 left-card">
      <div class="card">
        <div class="card-body">
          ...
          <h4 style="color:blue;text-align:center;">Appliances Repair/Service</h4>
          <ul>
            <li>AC Service @Rs499</li>
            <li>Washing Machine Service @Rs499</li>
            <li>Refrigerator Service @Rs499</li>
          </ul>
