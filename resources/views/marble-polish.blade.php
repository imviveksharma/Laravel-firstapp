  ...
  <div>
    ...
    <div>
        <div>
            ...
            <h1>Marble Polish In Bangalore</h1>
    ...
    <div class="col-md-6 left-card">
      <div class="card">
        <div class="card-body">
          ...
          <h4 style="color:blue;text-align:center;">Marble Polishing Services</h4>
          <ul>
            <li>Indian Marble Polishing</li>
            <li>Italian Marble Polishing</li>
